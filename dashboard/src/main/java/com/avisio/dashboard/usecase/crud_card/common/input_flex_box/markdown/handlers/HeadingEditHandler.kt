...
/*
source: https://github.com/noties/Markwon/blob/master/app-sample/src/main/java/io/noties/markwon/app/samples/editor/shared/HeadingEditHandler.java
date: 11-15-21
 */
class HeadingEditHandler : AvisioMarkdownEditHandler<HeadingSpan>() {

    override fun configurePersistedSpans(builder: PersistedSpans.Builder) {
        builder
            .persistSpan(Head1::class.java) { Head1(markdownTheme!!) }
            .persistSpan(Head2::class.java) { Head2(markdownTheme!!) }
            .persistSpan(Head3::class.java) { Head3(markdownTheme!!) }
    }

    override fun handleMarkdownSpan(persistedSpans: PersistedSpans, editable: Editable, input: String,
        span: HeadingSpan, spanStart: Int, spanTextLength: Int
    ) {
